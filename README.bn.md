...
২. এবার নিচের কমান্ডটি রান করুন:
   ...
   ```
   *(কমান্ডটি রান করার পর আপনাকে **Release** অথবা **Debug** টাইপ সিলেক্ট করতে বলা হবে। আপনি চাইলে সরাসরি ফ্ল্যাগ ব্যবহার করে প্রম্পট এড়াতে পারেন, যেমন: `mybuild build android --type debug`)*
