# mybuild: এক্সপো এবং রিঅ্যাক্ট নেটিভ অ্যাপের জন্য সেলফ-হোস্টেড বিল্ড সিস্টেম

[English README](README.md) | **বাংলা সংস্করণ**

এটি একটি সেলফ-হোস্টেড মোবাইল অ্যাপ বিল্ড সিস্টেম (যা এক্সপো/রিঅ্যাক্ট নেটিভ প্রজেক্টের সাথে সামঞ্জস্যপূর্ণ এবং Expo EAS-এর মতো কাজ করে)। এই প্রজেক্টের মাধ্যমে আপনি আপনার নিজের VPS সার্ভারে অ্যান্ড্রয়েড অ্যাপ বিল্ড করতে পারবেন, যার ফলে আপনার নিজের ল্যাপটপে কোনো Android SDK বা Java সেটআপ করতে হবে না।
...
### ধাপ ৪: অ্যাপ বিল্ড করা (Build Android APK/AAB)
...
২. এবার নিচের কমান্ডটি রান করুন:
   ...
   ```
   *(কমান্ডটি রান করার পর আপনাকে **Release APK**, **Release AAB**, অথবা **Debug APK** টাইপ সিলেক্ট করতে বলা হবে। আপনি চাইলে সরাসরি ফ্ল্যাগ ব্যবহার করে প্রম্পট এড়াতে পারেন, যেমন: `mybuild build android --type aab`)*

**কিভাবে কাজ করবে?**
- CLI আপনার প্রজেক্টকে জিপ করে সার্ভারে পাঠাবে (ভারী `node_modules` বাদ দিয়ে)।
- সার্ভার ফাইলটি রিসিভ করে বিল্ড কিউতে যোগ করবে।
- ব্যাকএন্ডে রান হওয়া ওয়ার্কার ফাইলটি এক্সট্র্যাক্ট করে `npm install` এবং `expo prebuild` শেষ করে অ্যান্ড্রয়েড বিল্ড শুরু করবে (টাইপ অনুযায়ী `assembleRelease`, `bundleRelease` অথবা `assembleDebug` রান করবে)।
- বিল্ডের রিয়েল-টাইম লগ আপনার ল্যাপটপের টার্মিনালে দেখতে পাবেন।
- বিল্ড শেষ হলে সরাসরি জেনারেট হওয়া ফাইলের ডাউনলোড লিংক পাবেন।
...
* **অ্যান্ড্রয়েড বিল্ড শুরু করতে (অবশ্যই এক্সপো প্রজেক্টের রুটে গিয়ে রান করতে হবে):**
  ```bash
  mybuild build android
  # অথবা সরাসরি বিল্ড টাইপ উল্লেখ করতে পারেন (প্রম্পট ছাড়া):
...
### ৫. 🚀 সরাসরি SSH/SCP দিয়ে ল্যাপটপে ফাইল ডাউনলোড করা (বিকল্প উপায়)
যদি ব্রাউজারে ডাউনলোড স্পিড কম থাকে বা ডাউনলোড আটকে যাওয়ার সমস্যা হয়, তবে ল্যাপটপের টার্মিনাল (সার্ভার নয়) থেকে সরাসরি এই কমান্ড দিয়ে আপনার **Downloads** ফোল্ডারে ফাইলটি নামিয়ে নিতে পারেন:
```bash
...
## ⚖️ আইনি নোটিশ এবং ট্রেডমার্ক সংক্রান্ত ডিসক্লেমার (Legal Disclaimer)

**mybuild** একটি সম্পূর্ণ স্বাধীন এবং অনফিশিয়াল ওপেন-সোর্স প্রজেক্ট। 

- **Expo** এবং **EAS (Expo Application Services)** হলো **650 Industries, Inc.** (যা Expo নামে পরিচিত)-এর রেজিস্টার্ড ট্রেডমার্ক।
- এই প্রজেক্টের সাথে 650 Industries, Inc., Expo বা EAS-এর কোনো অফিশিয়াল সম্পর্ক, স্পন্সরশিপ, বা অনুমোদন নেই।
- ডকুমেন্টেশনে ব্যবহৃত "Expo", "EAS" বা এই সংক্রান্ত শব্দগুলো শুধুমাত্র Expo SDK ব্যবহার করে তৈরি অ্যাপগুলোর সাথে প্রজেক্টের সামঞ্জস্যতা (compatibility) বোঝাতে বর্ণনামূলক উদ্দেশ্যে ব্যবহার করা হয়েছে।
